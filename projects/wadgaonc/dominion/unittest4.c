...
int main()
{
    ...
    printf("Begin Testing handleTribute():\n");
    ...
    int r1 = handleTribute(&G, 1, 0, tributeRevealedCards);
    int test2 = G.coins;
    printf("Num coins is %d\n", G.coins);
    if (test1 == test2 - 2)
    {
    ...
    int r2 = handleTribute(&G, 1, 0, tributeRevealedCards);
    test2 = G.handCount[0];
    printf("Handcount for player 0 is %d\n", G.handCount[0]);
    if (test1 == test2 - 2)
    {
    ...
    // for code coverage
    G.deckCount[1] = 1;
    int r3 = handleTribute(&G, 1, 0, tributeRevealedCards);
    G.discardCount[1] = 0;
    G.deckCount[1] = 0;
    int r4 = handleTribute(&G, 1, 0, tributeRevealedCards);
    G.discardCount[1] = 1;
    int r5 = handleTribute(&G, 1, 0, tributeRevealedCards);
